...
Upgrade `knowledge-ops` from a read-on-demand skill into a preprocess-first skill that can absorb new files, classify them, cache extracted text, and answer faster from processed artifacts.
...
- Added `references/answer_schema.md` to define a frontend-friendly answer contract with Markdown plus render blocks.
